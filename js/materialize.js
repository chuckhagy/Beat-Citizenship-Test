...
(function(factory) {
  ...
  $.extend($.easing, {
    ...
    easeInOutElastic: function(x) {
      return x === 0
        ? 0
        : x === 1 ? 1 : x < 0.5 ? -(pow(2, 20 * x - 10) * sin((20 * x - 11.125) * c5)) / 2 : pow(2, -20 * x + 10) * sin((20 * x - 11.125) * c5) / 2 + 1;
    },
      ...
      !(function(e) {
        function t(e) {
          ...
          return 'function' === a || r.isWindow(e)
            ? !1
            : 1 === e.nodeType && t ? !0 : 'array' === a || 0 === t || ('number' == typeof t && t > 0 && t - 1 in e);
        }
        if (!e.jQuery) {
          var r = function(e, t) {
          ...
          (r.isWindow = function(e) {
            ...
            var e,
              ...
              c = !1;
            for (
              'boolean' == typeof s && ((c = s), (s = arguments[l] || {}), l++), 'object' != typeof s && 'function' !== r.type(s) && (s = {}), l === u &&
                ((s = this), l--);
              u > l;
              l++
            ) {
                ...
                for (n in o) {
                  (e = s[n]), (a = o[n]), s !== a &&
                    (c && a && (r.isPlainObject(a) || (t = r.isArray(a)))
                      ? (t ? ((t = !1), (i = e && r.isArray(e) ? e : [])) : (i = e && r.isPlainObject(e) ? e : {}), (s[n] = r.extend(c, i, a)))
                      : void 0 !== a && (s[n] = a));
                }
            }
            return s;
            ...
            position: function() {
              ...
              return (a.top -= parseFloat(t.style.marginTop) || 0), (a.left -= parseFloat(t.style.marginLeft) || 0), e.style &&
                ((n.top += parseFloat(e.style.borderTopWidth) || 0), (n.left += parseFloat(e.style.borderLeftWidth) || 0)), {
                top: a.top - n.top,
                left: a.left - n.left
              };
            }
          ...
          for (
            var n = {}, o = n.hasOwnProperty, i = n.toString, s = 'Boolean Number String Function Array Date RegExp Object Error'.split(' '), l = 0;
            l < s.length;
            l++
          ) {
      ...
      (function(e) {
        ...
        return (function(e, t, r, a) {
                ...
                if (b.State.calls[o]) {
                  ...
                  for (var h = Math.min((t - d) / u.duration, 1), v = 0, x = l.length; x > v; v++) {
                    ...
                    if (i(V)) {
                      ...
                      u.mobileHA && i(V).transformCache.translate3d === a && ((i(V).transformCache.translate3d = '(0px, 0px, 0px)'), (C = !0)), C &&
                        S.flushTransformCache(V);
                    }
                  }
                  u.display !== a && 'none' !== u.display && (b.State.calls[o][2].display = !1), u.visibility !== a &&
                    'hidden' !== u.visibility &&
                    (b.State.calls[o][2].visibility = !1), u.progress && u.progress.call(s[1], s[1], h, Math.max(0, d + u.duration - t), d, y), 1 === h && p(o);
                }
              }
            }
          ...
          function p(e, t) {
            ...
            for (
              var r = b.State.calls[e][0], n = b.State.calls[e][1], o = b.State.calls[e][2], s = b.State.calls[e][4], l = !1, u = 0, c = r.length;
              c > u;
              u++
            ) {
              var p = r[u].element;
              if (
                ...
                }), o.mobileHA && ((d = !0), delete i(p).transformCache.translate3d), d && S.flushTransformCache(p), S.Values.removeClass(
                  p,
                  'velocity-animating'
                );
              }
          ...
          var x = (function() {
            ...
            return function a(e, t, n) {
              var o,
                ...
                f = 0.016;
              for (
                e = parseFloat(e) || 500, t = parseFloat(t) || 20, n = n || null, l.tension = e, l.friction = t, o = null !== n, o
                  ? ((c = a(e, t)), (i = c / n * f))
                  : (i = f);
          ...
          var S = (b.CSS = {
                  ...
                  switch (e) {
                    ...
                    case 'extract':
                      ...
                      return S.RegEx.wrappedValueAlreadyExtracted.test(r)
                        ? (a = r)
                        : ((a = r.toString().match(S.RegEx.valueUnwrap)), (a = a ? a[1].replace(/,(\s+)?/g, ' ') : r)), a;
                    case 'inject':
                      return 'rect(' + r + ')';
                  }
                },
                      ...
                      switch (e) {
                        ...
                        case 'extract':
                          ...
                          if (S.RegEx.wrappedValueAlreadyExtracted.test(n)) o = n;
                            ...
                            /^[A-z]+$/i.test(n)
                              ? (i = s[n] !== a ? s[n] : s.black)
                              : S.RegEx.isHex.test(n) ? (i = 'rgb(' + S.Values.hexToRgb(n).join(' ') + ')') : /^rgba?\(/i.test(n) || (i = s.black), (o = (i ||
                              n)
                              .toString()
            ...
            Values: {
              ...
              getUnitType: function(e) {
                return /^(rotate|skew)/i.test(e)
                  ? 'deg'
                  : /(^(scale|scaleX|scaleY|scaleZ|alpha|flexGrow|flexHeight|zIndex|fontWeight)$)|((opacity|red|green|blue|alpha)$)/i.test(e) ? '' : 'px';
              },
              getDisplayType: function(e) {
                ...
                return /^(b|big|i|small|tt|abbr|acronym|cite|code|dfn|em|kbd|strong|samp|var|a|bdo|br|img|map|object|q|script|span|sub|sup|button|input|label|select|textarea)$/i.test(
                  ...
                  : /^(li)$/i.test(t)
                    ? 'list-item'
                    : /^(tr)$/i.test(t) ? 'table-row' : /^(table)$/i.test(t) ? 'table' : /^(tbody)$/i.test(t) ? 'table-row-group' : 'block';
              },
                ...
                if (8 >= d) l = f.css(e, r);
                  ...
                  (g =
                    i(e) === a
                      ...
                      : i(e).computedStyle ? i(e).computedStyle : (i(e).computedStyle = t.getComputedStyle(e, null))), 'borderColor' === r &&
                    (r = 'borderTopColor'), (l = 9 === d && 'filter' === r ? g.getPropertyValue(r) : g[r]), ('' === l || null === l) && (l = e.style[r]), n();
                }
            ...
            setPropertyValue: function(e, r, a, n, o) {
              ...
              if ('scroll' === r)
                ...
                if (
                  (
                    S.Normalizations.registered[r] && ((a = S.Normalizations.registered[r]('inject', e, a)), (r = S.Normalizations.registered[r]('name', e))),
            ...
            flushTransformCache: function(e) {
              ...
              if ((d || (b.State.isAndroid && !b.State.isChrome)) && i(e).isSVG) {
                ...
                f.each(i(e).transformCache, function(e) {
                  /^translate/i.test(e)
                    ? (e = 'translate')
                    : /^scale/i.test(e) ? (e = 'scale') : /^rotate/i.test(e) && (e = 'rotate'), a[e] && ((r += e + '(' + a[e].join(' ') + ') '), delete a[e]);
                });
              } else {
                var n, o;
          ...
          var P = function() {
            ...
            function n() {
              function e(e) {
                function p(e, t) {
                  ...
                  return m.isArray(e)
                    ...
                    : (r = e), t || (n = n || s.easing), m.isFunction(r) && (r = r.call(o, V, w)), m.isFunction(i) && (i = i.call(o, V, w)), [r || 0, n, i];
                }
                function d(e, t) {
                  var r, a;
                ...
                function h() {
                  ...
                  if (n && a) (l.emToPx = L.lastEmToPx), (l.percentToPxWidth = L.lastPercentToPxWidth), (l.percentToPxHeight = L.lastPercentToPxHeight);
                    ...
                    }), b.CSS.setPropertyValue(u, 'position', e.position), b.CSS.setPropertyValue(u, 'fontSize', e.fontSize), b.CSS.setPropertyValue(
                      u,
                      'boxSizing',
                      'content-box'
                    ), f.each(['minWidth', 'maxWidth', 'width', 'minHeight', 'maxHeight', 'height'], function(e, t) {
                      b.CSS.setPropertyValue(u, t, s + '%');
                    }), b.CSS.setPropertyValue(u, 'paddingLeft', s + 'em'), (l.percentToPxWidth = L.lastPercentToPxWidth =
                      (parseFloat(S.getPropertyValue(u, 'width', null, !0)) || 1) / s), (l.percentToPxHeight = L.lastPercentToPxHeight =
                      (parseFloat(S.getPropertyValue(u, 'height', null, !0)) || 1) / s), (l.emToPx = L.lastEmToPx =
                      (parseFloat(S.getPropertyValue(u, 'paddingLeft')) || 1) / s), e.myParent.removeChild(u);
                  }
                  return null === L.remToPx && (L.remToPx = parseFloat(S.getPropertyValue(r.body, 'fontSize')) || 16), null === L.vwToPx &&
                    ((L.vwToPx = parseFloat(t.innerWidth) / 100), (L.vhToPx = parseFloat(t.innerHeight) / 100)), (l.remToPx = L.remToPx), (l.vwToPx =
                    L.vwToPx), (l.vhToPx = L.vhToPx), b.debug >= 1 && console.log('Unit ratios: ' + JSON.stringify(l), o), l;
                }
                if (s.begin && 0 === V)
                  try {
                    s.begin.call(g, g);
                ...
                if ('scroll' === A) {
                  ...
                  s.container
                    ? m.isWrapped(s.container) || m.isNode(s.container)
                      ? ((s.container = s.container[0] || s.container), (P = s.container['scroll' + F]), (T = P + f(o).position()[F.toLowerCase()] + j))
                      : (s.container = null)
                    : (
                  ...
                  'none' === i(o).opts.display && (i(o).opts.display = 'auto'), 'hidden' === i(o).opts.visibility && (i(o).opts.visibility = 'visible'), (i(
                    o
                  ).opts.loop = !1), (i(o).opts.begin = null), (i(o).opts.complete = null), v.easing || delete s.easing, v.duration ||
                    delete s.duration, (s = f.extend({}, i(o).opts, s));
                  var E = f.extend(!0, {}, i(o).tweensContainer);
                  for (var H in E) {
                    if ('element' !== H) {
                      var N = E[H].startValue;
                      (E[H].startValue = E[H].currentValue = E[H].endValue), (E[H].endValue = N), m.isEmptyObject(v) || (E[H].easing = s.easing), b.debug &&
                  ...
                  for (var z in y) {
                    ...
                    if (i(o).isSVG || 'tween' === I || S.Names.prefixCheck(I)[1] !== !1 || S.Normalizations.registered[I] !== a) {
                      ((s.display !== a && null !== s.display && 'none' !== s.display) || (s.visibility !== a && 'hidden' !== s.visibility)) &&
                        ...
                        : S.Hooks.registered[z]
                          ? M === a ? ((B = S.getPropertyValue(o, I)), (M = S.getPropertyValue(o, z, B))) : (B = S.Hooks.templates[I][1])
                        ...
                        (
                          ...
                          '%' === G &&
                            (/^(fontSize|lineHeight)$/.test(z)
                              ? ((q /= 100), (G = 'em'))
                              : /^scale/.test(z) ? ((q /= 100), (G = '')) : /(Red|Green|Blue)$/i.test(z) && ((q = q / 100 * 255), (G = ''))),
                          /[\/*]/.test(D)
                        )
                      )
                        G = Y;
                      ...
                      (l[z] = { rootPropertyValue: B, startValue: M, currentValue: M, endValue: q, unitType: G, easing: $ }), b.debug &&
              ...
              b.mock !== !1 &&
                (b.mock === !0 ? (s.duration = s.delay = 1) : ((s.duration *= parseFloat(b.mock) || 1), (s.delay *= parseFloat(b.mock) || 1))), (s.easing = u(
                s.easing,
                s.duration
              )), s.begin && !m.isFunction(s.begin) && (s.begin = null), s.progress && !m.isFunction(s.progress) && (s.progress = null), s.complete &&
                !m.isFunction(s.complete) &&
                (s.complete = null), s.display !== a &&
                null !== s.display &&
                ((s.display = s.display.toString().toLowerCase()), 'auto' === s.display && (s.display = b.CSS.Values.getDisplayType(o))), s.visibility !== a &&
                null !== s.visibility &&
                (s.visibility = s.visibility.toString().toLowerCase()), (s.mobileHA = s.mobileHA && b.State.isMobile && !b.State.isGingerbread), s.queue === !1
            ...
            var s,
              ...
              x =
                arguments[0] &&
                (arguments[0].p || (f.isPlainObject(arguments[0].properties) && !arguments[0].properties.names) || m.isString(arguments[0].properties));
            if (
              (
                m.isWrapped(this)
              ...
              switch (y) {
                ...
                case 'stop':
                  f.each(g, function(e, t) {
                    i(t) &&
                      i(t).delayTimer &&
                      (clearTimeout(i(t).delayTimer.setTimeout), i(t).delayTimer.next && i(t).delayTimer.next(), delete i(t).delayTimer);
                  });
                  var F = [];
          ...
          return b.State.isMobile ||
            ...
            b.Redirects['slide' + t] = function(e, r, n, o, i, s) {
              var l = f.extend({}, r),
                ...
                d = {};
              l.display === a &&
                (l.display = 'Down' === t ? ('inline' === b.CSS.Values.getDisplayType(e) ? 'inline-block' : 'block') : 'none'), (l.begin = function() {
                u && u.call(i, i);
                for (var r in p) {
                  d[r] = e.style[r];
...
!(function(a, b, c, d) {
  ...
  function db(a, b) {
    ...
    var f = c.firstInput,
      ...
      i = (b.center = hb(d));
    (b.timeStamp = j()), (b.deltaTime = b.timeStamp - f.timeStamp), (b.angle = lb(h, i)), (b.distance = kb(h, i)), eb(c, b), (b.offsetDirection = jb(
      b.deltaX,
      b.deltaY
    )), (b.scale = g ? nb(g.pointers, d) : 1), (b.rotation = g ? mb(g.pointers, d) : 0), fb(c, b);
    var k = a.element;
  ...
  function eb(a, b) {
    ...
    (b.eventType === O || f.eventType === Q) &&
      ((e = a.prevDelta = { x: f.deltaX || 0, y: f.deltaY || 0 }), (d = a.offsetDelta = { x: c.x, y: c.y })), (b.deltaX = e.x + (c.x - d.x)), (b.deltaY =
      e.y + (c.y - d.y));
  }
  function fb(a, b) {
    var f,
  ...
  function Yb(a) {
    (this.id = D()), (this.manager = null), (this.options = o(a || {}, this.defaults)), (this.options.enable = s(
      this.options.enable,
      !0
  ...
  function kc(a, b) {
    (b = b || {}), (this.options = o(b, hc.defaults)), (this.options.inputTarget =
      this.options.inputTarget || a), (this.handlers = {}), (this.session = {}), (this.recognizers = []), (this.element = a), (this.input = bb(
      this
    )), (this.touchAction = new Pb(this, this.options.touchAction)), lc(this, !0), m(
      b.recognizers,
      function(a) {
  ...
  ab.prototype = {
    handler: function() {},
    init: function() {
      this.evEl && t(this.element, this.evEl, this.domHandler), this.evTarget && t(this.target, this.evTarget, this.domHandler), this.evWin &&
        t(E(this.element), this.evWin, this.domHandler);
    },
    destroy: function() {
      this.evEl && u(this.element, this.evEl, this.domHandler), this.evTarget && u(this.target, this.evTarget, this.domHandler), this.evWin &&
  ...
  p(rb, ab, {
    handler: function(a) {
      ...
      b & O && 0 === a.button && (this.pressed = !0), b & P && 1 !== a.which && (b = Q), this.pressed &&
        this.allow &&
        (b & Q && (this.pressed = !1), this.callback(this.manager, b, { pointers: [a], changedPointers: [a], pointerType: L, srcEvent: a }));
    }
  });
  ...
  a.MSPointerEvent && ((ub = 'MSPointerDown'), (vb = 'MSPointerMove MSPointerUp MSPointerCancel')), p(wb, ab, {
    handler: function(a) {
      ...
      e & O && (0 === a.button || g) ? 0 > h && (b.push(a), (h = b.length - 1)) : e & (Q | R) && (c = !0), 0 > h ||
        ((b[h] = a), this.callback(this.manager, e, { pointers: b, changedPointers: [a], pointerType: f, srcEvent: a }), c && b.splice(h, 1));
    }
  });
  ...
  (Yb.prototype = {
    ...
    directionTest: function(a) {
      ...
      return e & b.direction ||
        (b.direction & X
          ...
          : ((e = 0 === g ? S : 0 > g ? V : W), (c = g != this.pY), (d = Math.abs(a.deltaY)))), (a.direction = e), c && d > b.threshold && e & b.direction;
    },
    attrTest: function(a) {
    ...
    attrTest: function(a) {
      ...
      return b & (X | Y) ? (c = a.velocity) : b & X ? (c = a.velocityX) : b & Y && (c = a.velocityY), this._super.attrTest.call(this, a) &&
        b & a.direction &&
    ...
    recognize: function(a) {
      ...
      if (!b.stopped) {
        ...
        for (var f = 0; f < d.length; ) {
          (c = d[f]), b.stopped === jc || (e && c != e && !c.canRecognizeWith(e)) ? c.reset() : c.recognize(a), !e &&
            c.state & (Sb | Tb | Ub) &&
      ...
      origin.on({
        'mouseenter.tooltip': function(e) {
          var showTooltip = function() {
            ...
            tooltipEl
              .velocity({ translateY: tooltipVerticalMovement, translateX: tooltipHorizontalMovement }, { duration: 350, queue: false })
...
(function($) {
  ...
  $.fn.material_select = function(callback) {
    $(this).each(function() {
      ...
      var options = $(
          '<ul id="select-options-' + uniqueID + '" class="dropdown-content select-dropdown ' + (multiple ? 'multiple-select-dropdown' : '') + '"></ul>'
        ),
    ...
    init: function(options) {
      ...
      return this.each(function() {
        ...
        $active.find('img').each(function() {
          $active
            .find('.caption')
            .velocity({ opacity: 1, translateX: 0, translateY: 0 }, { duration: options.transition, queue: false, easing: 'easeOutQuad' });
        });
...
(function($) {
  ...
  var closeFABMenu = function(btn) {
    ...
    $this
      ...
      .velocity({ opacity: '0', scaleX: '.4', scaleY: '.4', translateY: offsetY + 'px', translateX: offsetX + 'px' }, { duration: 80 });
  };
    ...
    return (
      ...
      _.node(
        ...
        _.node(
          ...
          _.node(
            'div',
            (settings.selectYears ? createMonthLabel() + createYearLabel() : createMonthLabel() + createYearLabel()) + createMonthNav() + createMonthNav(1),
...
(function() {
  ...
  function ClockPicker(element, options) {
    ...
    $('<button type="button" class="btn-flat picker__clear" tabindex="' + (options.twelvehour ? '3' : '1') + '">' + options.cleartext + '</button>')
      .click($.proxy(this.clear, this))
      .appendTo(this.footer);
    $('<button type="button" class="btn-flat picker__close" tabindex="' + (options.twelvehour ? '3' : '1') + '">' + options.canceltext + '</button>')
      .click($.proxy(this.hide, this))
      .appendTo(this.footer);
    $('<button type="button" class="btn-flat picker__close" tabindex="' + (options.twelvehour ? '3' : '1') + '">' + options.donetext + '</button>')
